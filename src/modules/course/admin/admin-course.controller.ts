...
export class AdminCourseController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Admin - Get all courses with pagination, sort, and search',
  })
  @ApiQuery({
    name: 'keySearch',
    type: String,
  ...
  @ApiQuery({
    ...
    type: String,
    required: false,
    description: 'Field to sort by (e.g., title, price, createdAt)',
  })
  @ApiQuery({
    name: 'sortOrder',
    type: String,
  ...
  @RequirePermissions({ object: AdminObject.course, action: AdminAction.view })
