...
export class AdminUserController {
  ...
  @ApiQuery({ name: 'keySearch', required: false, description: 'Search by full name or email' })
  ...
  @Get(':userId')
  @ApiOperation({ summary: 'Get user detail by ID (includes teacherSettings and courses for teachers)' })
  ...
  async updateUserStatus(
    ...
    return this.adminUserService.updateUserStatus(userId, updateStatusDto.status);
  }
}