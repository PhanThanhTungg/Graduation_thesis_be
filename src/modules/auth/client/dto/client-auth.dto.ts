...
export class ClientRegisterDto {
  ...
  @ApiProperty({
    description:
      'Contains at least 1 lowercase letter, 1 uppercase letter, 1 number and 1 special character',
  })
  password: string;
...
export class ResetPasswordDto {
  ...
  @ApiProperty({
    description:
      'The new password. Contains at least 1 lowercase letter, 1 uppercase letter, 1 number and 1 special character',
  })
  newPassword: string;
}
